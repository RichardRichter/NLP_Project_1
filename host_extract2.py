...
for line in sample_of_lines:
    # we want to get tweets that mention "host" but ignore tweets that contain "next" as those are predictions/desires for future hosts
...
# iterate through the remainining 1/10ths of the tweets except for the last 1/10th
for i in range(1, 9):
    n = i + 1
...
# retrieve the final 10th of the tweets to analyze, this is separate for the other for loop to cover weird integer division
